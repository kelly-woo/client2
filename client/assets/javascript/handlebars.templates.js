...
this["JST"]["client/app/center/messages/services/renderers/templates/center.date.tmpl"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var helper;
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.file.comment.title.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.file.comment.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.file.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.main.tmpl"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.system.event.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.text.child.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.text.link.preview.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.lambda, alias2=this.escapeExpression;
...
this["JST"]["client/app/center/messages/services/renderers/templates/center.text.tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
