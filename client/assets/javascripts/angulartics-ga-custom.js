 ...
 * License: MIT
 *
 * Customized by JiHoon.
 * overriding 'bower_components/angulartis/src/angulartics-ga.js'
 *
 * added line sending 'pageview' event to 'global_tracker'.
 */
...
(function(angular) {
     ...
     */
    angular.module('angulartics.google.analytics.custom', ['angulartics'])
            ...
            $analyticsProvider.registerPageTrack(function (path) {
                ...
                if (window.ga) {
                    ...
                    ga(function() {
                        ...
                        for (var i = 1; i < allTrackers.length; ++i) {
                            var tracker = allTrackers[i];
                            ga(tracker.get('name')+'.'+send_command, hit_type, path);
                        }
                    });
                }
            });
