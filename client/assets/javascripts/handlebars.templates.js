...
this["Handlebars"]["templates"]["center.file"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers['if'].call(depth0,((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.hasPermission : stack1),{"name":"if","hash":{},"fn":this.program(4, data, 0),"inverse":this.program(19, data, 0),"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.unless.call(depth0,((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.mustPreview : stack1),{"name":"unless","hash":{},"fn":this.program(21, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"4":function(depth0,helpers,partials,data) {
    var stack1;
  ...
  return "          <!--  FILE INFO -->\n          <div class=\"msg-file-meta\">\n            <div class=\"msg-file-meta-up\">\n              <!--  NOT ARCHIVED FILE -->\n              <!--    TITLE   -->\n              <a class=\"msg-file-meta__title file__name break-word cursor_pointer _fileGo\">"
    ...
    + "            </div>\n\n"
    + ((stack1 = helpers.unless.call(depth0,((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.isUnshared : stack1),{"name":"unless","hash":{},"fn":this.program(15, data, 0),"inverse":this.program(17, data, 0),"data":data})) != null ? stack1 : "")
    + "          </div>\n";
},"6":function(depth0,helpers,partials,data) {
    var stack1;
  ...
  return "          <!--  FILE PREVIEW IMAGE  -->\n          <div class=\"preview-container\">\n            <div class=\"preview-card cursor_pointer _compile _fileGo\">\n              <div class=\"msg-file-actions-content actions-dimmed\"></div>\n              <div class=\"msg-file-actions-content non-selectable\">\n                <div class=\"msg-file-actions\">\n"
    + ((stack1 = helpers.unless.call(depth0,((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.isUnshared : stack1),{"name":"unless","hash":{},"fn":this.program(22, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "                  <div class=\"action-group\">\n                    <div class=\"action-item\"\n                         jnd-tooltip-trigger=\""
    + alias1((helpers.translate || (depth0 && depth0.translate) || helpers.helperMissing).call(depth0,"@btn-file-detail",{"name":"translate","hash":{},"data":data}))
    + "\"\n                         data-direction=\"top\">\n                      <!--  FILE DETAIL -->\n                      <i class=\"action-file-detail icon-arrow-right _fileDetail\"></i>\n                    </div>\n                  </div>\n                </div>\n              </div>\n\n              <!--    FILE TYPE THUMBNAIL -->\n              <div class=\"card-type\">\n                <div class=\"fileicon fileicon-"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.icon : stack1), depth0))
    ...
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.type : stack1), depth0))
    + "</span>\n                </div>\n              </div>\n            </div>\n\n"
    + ((stack1 = helpers.unless.call(depth0,((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.isUnshared : stack1),{"name":"unless","hash":{},"fn":this.program(30, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "          </div>\n";
