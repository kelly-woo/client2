(function() {
    ...
    messageAPIservice.$inject = ['$http', '$rootScope', 'memberService'];
    
    function messageAPIservice($http, $rootScope, memberService) {
        var service = {
        ...
        // get message lists
        function getMessages(entityType, entityId, offset, limit) {
